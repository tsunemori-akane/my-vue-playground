...
const jsxTable = defineComponent({
  name: 'jsxTable',
  props: {
...
function install(app: ReturnType<typeof createApp>, options = {}) {
  app.component(jsxTable.name, jsxTable);
}

type JsxTable = typeof jsxTable & {
  install: (app: App, options?: Record<string, any>) => void;
};

jsxTable.install = install;

export default jsxTable as JsxTable;
